...
class TestAPIWeightsRecent:
    ...
    def test_get_recent_weights_success(self, client, sample_user, sample_weights):
    ...
    def test_get_recent_weights_empty(self, client, sample_user):
    ...
    def test_get_recent_weights_limit_five(self, client, sample_user):
    ...
    def test_get_recent_weights_format(self, client, sample_user, sample_weights):
...
class TestAPIUserEdgeCases:
    ...
    def test_create_user_height_nan(self, client):
    ...
    def test_create_user_height_infinity(self, client):
    ...
    def test_create_user_height_negative_infinity(self, client):
        """Test error cuando altura es -Infinity"""
        import math
        data = {
            'nombre': 'Test',
    ...
    def test_create_user_height_list_type(self, client):
    ...
    def test_create_user_height_dict_type(self, client):
    ...
    def test_create_user_birth_date_before_min(self, client):
    ...
    def test_create_user_birth_date_future(self, client):
    ...
    def test_create_user_height_min_boundary(self, client):
    ...
    def test_create_user_height_max_boundary(self, client):
    ...
    def test_create_user_height_below_min(self, client):
    ...
    def test_create_user_height_above_max(self, client):
...
class TestAPIWeightEdgeCases:
    ...
    def test_add_weight_nan(self, client, sample_user):
    ...
    def test_add_weight_infinity(self, client, sample_user):
    ...
    def test_add_weight_negative_infinity(self, client, sample_user):
        """Test error cuando peso es -Infinity"""
        import math
        data = {'peso_kg': float('-inf')}
        response = client.post('/api/weight', data=json.dumps(data), content_type='application/json')
