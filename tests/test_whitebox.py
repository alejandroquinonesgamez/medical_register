...
class TestBoundaryValuesAPI:
    ...
    def test_talla_minimo_valido(self, client):
    ...
    def test_talla_maximo_valido(self, client):
    ...
    def test_talla_justo_bajo_minimo(self, client):
    ...
    def test_talla_justo_sobre_maximo(self, client):
    ...
    def test_peso_minimo_valido(self, client, sample_user):
        """Límite inferior válido"""
    ...
    def test_peso_maximo_valido(self, client, sample_user):
        """Límite superior válido"""
        data = {'peso_kg': VALIDATION_LIMITS['weight_max']}
        response = client.post('/api/weight', data=json.dumps(data), content_type='application/json')
        assert_created(response)
    
    def test_peso_justo_bajo_minimo(self, client, sample_user):
        """Límite inferior inválido (justo debajo del mínimo)"""
        data = {'peso_kg': VALIDATION_LIMITS['weight_min'] - 0.1}
        response = client.post('/api/weight', data=json.dumps(data), content_type='application/json')
        assert_bad_request(response)
    
    def test_peso_justo_sobre_maximo(self, client, sample_user):
        """Límite superior inválido (justo sobre el máximo)"""
        data = {'peso_kg': VALIDATION_LIMITS['weight_max'] + 0.1}
        response = client.post('/api/weight', data=json.dumps(data), content_type='application/json')
        assert_bad_request(response)
    
    def test_fecha_minimo_valido(self, client):
        """Límite inferior válido"""
        data = {
            'nombre': 'Test',
            'apellidos': 'User',
    ...
    def test_fecha_maximo_valido(self, client):
    ...
    def test_fecha_justo_bajo_minimo(self, client):
        """Límite inferior inválido (justo debajo del mínimo)"""
    ...
    def test_fecha_justo_sobre_maximo(self, client):
...
class TestEquivalencePartitionsAPI:
    ...
    def test_talla_particion_invalida_baja(self, client):
    ...
    def test_talla_particion_valida(self, client):
    ...
    def test_talla_particion_invalida_alta(self, client):
    ...
    def test_peso_particion_invalido_bajo(self, client, sample_user):
    ...
    def test_peso_particion_valido(self, client, sample_user):
    ...
    def test_peso_particion_invalido_alto(self, client, sample_user):
    ...
    def test_fecha_particion_invalida_antigua(self, client):
    ...
    def test_fecha_particion_valida(self, client):
    ...
    def test_fecha_particion_invalida_futura(self, client):
